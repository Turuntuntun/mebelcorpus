...
if ( in_array( $cityName, Array( 'Санкт-Петербург', 'Москва', 'Краснодар' ) ) )
{
	global $arShopsFilter;
	
	$arShopsFilter['PROPERTY_CITY_VALUE'] = $cityName;
}
?>


<?$APPLICATION->IncludeComponent("bitrix:news.list", "shops2_sunduk", array(
