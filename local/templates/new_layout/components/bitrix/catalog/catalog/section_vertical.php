...
if ($currentSection['IBLOCK_SECTION_ID']) {
    $sectionListParams['SECTION_CODE'] = CIBlockSection::getById($currentSection['IBLOCK_SECTION_ID'])->GetNext()['CODE'];
}
        ...
        <div class="catalog-section__filter-menu filter-menu">
            ...
            <button class="filter-menu__btn" data-modal-trigger="full-filter">
                <svg width="12" height="12">
                    <use xlink:href="<?=SITE_TEMPLATE_PATH?>/assets/images/sprite.svg#settings"></use>
