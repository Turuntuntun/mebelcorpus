...
$displayModeClass = $arParams['DISPLAY_MODE'] === 'compact' ? ' basket-items-list-wrapper-compact' : '';
    if (empty($arResult['ERROR_MESSAGE']))
    {
        ...
        ?>
        <div id="basket-root" class="cart__wrap">
                <ul class="cart__list cart-list" id="basket-item-table"></ul>
                <div class="cart__side cart-side" data-entity="basket-total-block"></div>
        </div>
        <?
