...
?><section class="cart mb-90">
<div class="container">
	<h1 class="cart__title title-first mb-60">Корзина</h1>
	...
	Array(
		...
		"COLUMNS_LIST_EXT" => array("PREVIEW_PICTURE","DELETE","PROPERTY_COLOR","PROPERTY_CML2_ARTICLE"),
