            ...
            if ($arParams['USE_FAVORITE']=='Y' || $arParams['USE_CHEAPER']=='Y') {
                ?><div class="favoriteandcheaper"><?
                    ...
                    if ($arParams['USE_CHEAPER'] == 'Y') {
                        ?><div class="cheaper"><?
                            ?><a rel="nofollow" class="cheaper detail fancyajax fancybox.ajax" href="<?=SITE_DIR?>include/popup/cheaper/" title="<?=GetMessage('CHEAPER')?>"><?
                                ?><svg class="svg-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-pig"></use></svg><?
                                ?><?=GetMessage('CHEAPER')?></a><?
                        ?></div><?
                    }
                ?></div><?
            }
