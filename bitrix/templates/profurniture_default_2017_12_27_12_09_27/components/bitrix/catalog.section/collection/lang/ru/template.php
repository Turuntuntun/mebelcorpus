...
$MESS['ADD2COMPARE'] = 'Добавить к сравнению';
$MESS['FAVORITE'] = 'В избранное';

$MESS['GOPRO_TH_PRODUCT'] = 'Товар';
$MESS['GOPRO_TH_QUANTITY'] = 'Наличие';
$MESS['GOPRO_TH_ZAKAZ'] = 'Заказать';

$MESS['GOPRO_QUANTITY_ISSET'] = 'Есть';
$MESS['GOPRO_QUANTITY_LOW'] = 'Мало';
$MESS['GOPRO_QUANTITY_EMPTY'] = 'Нет';

$MESS['ADD2BASKET'] = 'Добавить в корзину';

$MESS['EMAIL2FRIEND'] = 'Поделиться с другом';
$MESS['YSHARE'] = 'Поделиться...';
$MESS['YSHARE2'] = 'Поделиться с друзъями';

$MESS['ERROR_EMPTY_ITEMS'] = 'В данном разделе товары отсутствуют';

$MESS['AJAXPAGES_LOAD_MORE'] = 'Загрузить еще';
