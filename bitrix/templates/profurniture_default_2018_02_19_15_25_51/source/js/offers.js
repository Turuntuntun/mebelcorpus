...
function RSGoPro_OffersExt_ChangeHTML($product) {
	...
	if ($product.find('.js-article').length > 0) {
		if (RSGoPro_OFFERS[element_id].OFFERS[finedOfferID].ARTICLE) {
			$product.find('.js-article').html(RSGoPro_OFFERS[element_id].OFFERS[finedOfferID].ARTICLE).parent('.js-article').removeClass('js-article-invisible');
		} else if ($product.find('.js-article').data('prodarticle') ) {
			$product.find('.js-article').html($product.find('.js-article').data('prodarticle')).parent('.js-article').removeClass('js-article-invisible');
		} else {
			$product.find('.js-article').parent('.js-article').addClass('js-article-invisible');
		}
	}
