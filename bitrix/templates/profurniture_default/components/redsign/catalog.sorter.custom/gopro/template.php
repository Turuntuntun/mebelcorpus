...
<div class="ownd-b-sorter b-sorter js-sorter clearfix" <?php if (isset($arParams['AJAXPAGESID']) && $arParams['AJAXPAGESID'] != ''): ?> data-ajaxpagesid="<?=$arParams['AJAXPAGESID']?>"<?php endif; ?>>
                        ...
                        <div class="b-sorter__dropdown js-sorter__dropdown">
                            ...
                            ?><div class="b-sorter__dropdown-in">
                                <?php foreach ($arResult['COUTPUT'] as $output): ?>
                                    <a class="<?=($output['USING'] == 'Y' ? "selected " : "")?>js-sorter__a" href="<?=$output['URL']?>"><?
