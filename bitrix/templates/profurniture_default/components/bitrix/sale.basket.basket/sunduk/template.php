...
$( document ).ready(
	function ()
	{
		$( '.ownd-basket-color-item' ).click(
			function ()
			{
				var colorName = $( this ).find( '.ownd-basket-color-name' ).text();
				var itemId = $( this ).parents( 'tr.basket-items-list-item-container' ).data( 'id' );
				
				$.post(
					'/_ajax/change_color.php',
					{
