								...
								foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName)
								{
									switch (trim((string)$blockName))
									{
										case 'props':
											...
											?>
											<div class="ownd-basket-color-list">
											{{#COLOR_SELECT}}
												<div class="ownd-basket-color-item {{ACTIVE}}" data-color-code="{{CODE}}">
													<div class="ownd-basket-color-image">
														<img src="{{PICTURE}}" alt="" />
													</div>
													<div class="ownd-basket-color-name">{{NAME}}</div>
												</div>
											{{/COLOR_SELECT}}
											</div>
											<?
