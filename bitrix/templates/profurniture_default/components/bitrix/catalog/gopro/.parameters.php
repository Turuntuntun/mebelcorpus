...
$arTemplateParameters = array(
	...
	'PROP_ARTICLE' => array(
		...
		'TYPE' => 'LIST',
		'VALUES' => array_merge(array('ID' => GetMessage('PROP_ARTICLE_FROM_ID')), $listProp['SNL']),
		'REFRESH' => 'Y',
	),
	...
	'IMPORTANT_PROPS' => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('IMPORTANT_PROPS'),
		'TYPE' => 'LIST',
		'MULTIPLE' => 'Y',
		'VALUES' => $listProp['ALL'],
	),
	'IMPORTANT_PROPS_LINK_TO_TAB' => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('IMPORTANT_PROPS_LINK_TO_TAB'),
		'TYPE' => 'CHECKBOX',
		'VALUE' => 'Y',
		'DEFAULT' => 'Y',
	),
    ...
    'DETAIL_SHOW_SIZE_TABLE' => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('RS_GOPRO_DETAIL_SHOW_SIZE_TABLE'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
		'REFRESH' => 'Y'
	),
...
if (IntVal($arCatalog["OFFERS_IBLOCK_ID"])) {
	...
	if ($arCurrentValues['PROP_ARTICLE'] != 'ID') {
		$arTemplateParameters['PROP_SKU_ARTICLE'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => GetMessage('PROP_SKU_ARTICLE'),
			'TYPE' => 'LIST',
			'VALUES' => array_merge(array('ID' => GetMessage('PROP_SKU_ARTICLE_FROM_ID')), $listProp2['SNL']),
		);
	}
...
if (!isset($arCurrentValues['USE_STORE']) || $arCurrentValues['USE_STORE'] == 'Y') {
    ...
    $arTemplateParameters['STORE_REPLACE_IF_NOT_AVAILABLE'] = array(
        'PARENT' => 'STORE_SETTINGS',
        'NAME' => GetMessage('STORE_REPLACE_IF_NOT_AVAILABLE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    );
}
...
if (!empty($arCurrentValues['PROP_BRAND'])) {
	...
	if ($arCurrentValues['BRAND_DETAIL_SHOW_LOGO'] == 'Y') {
		$arTemplateParameters['BRAND_DETAIL_IMG_SIZE_W'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => GetMessage('BRAND_DETAIL_IMG_SIZE_W'),
			'TYPE' => 'STRING',
			'DEFAULT' => '50',
		);
		$arTemplateParameters['BRAND_DETAIL_IMG_SIZE_H'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => GetMessage('BRAND_DETAIL_IMG_SIZE_H'),
			'TYPE' => 'STRING',
			'DEFAULT' => '50',
		);
		...
		if (!empty($arCurrentValues['BRAND_IBLOCK_BRANDS'])) {
			...
			$arTemplateParameters['BRAND_DETAIL_ADD_DETAIL_PAGE_URL'] = array(
				'PARENT' => 'DETAIL_SETTINGS',
				'NAME' => GetMessage('BRAND_DETAIL_ADD_DETAIL_PAGE_URL'),
				'TYPE' => 'CHECKBOX',
				'VALUE' => 'Y',
				'DEFAULT' => 'Y',
			);
...
if ($arCurrentValues['YM_USE_TARGETS'] == 'Y') {
	...
	$arTemplateParameters['YM_TARGET_NAME_ADD2BASKET'] = array(
		'NAME' => GetMessage('YM_TARGET_NAME_ADD2BASKET'),
		'TYPE' => 'STRING',
	);
	$arTemplateParameters['YM_TARGET_NAME_ADD2COMPARE'] = array(
		'NAME' => GetMessage('YM_TARGET_NAME_ADD2COMPARE'),
		'TYPE' => 'STRING',
	);
	$arTemplateParameters['YM_TARGET_NAME_ADD2COMPARE_IN'] = array(
		'NAME' => GetMessage('YM_TARGET_NAME_ADD2COMPARE_IN'),
		'TYPE' => 'STRING',
	);
	$arTemplateParameters['YM_TARGET_NAME_ADD2FAVORITE'] = array(
		'NAME' => GetMessage('YM_TARGET_NAME_ADD2FAVORITE'),
		'TYPE' => 'STRING',
	);
	$arTemplateParameters['YM_TARGET_NAME_ADD2FAVORITE_IN'] = array(
		'NAME' => GetMessage('YM_TARGET_NAME_ADD2FAVORITE_IN'),
		'TYPE' => 'STRING',
	);

	$arTemplateParameters['YM_TARGET_PARAMETERS'] = array(
		'NAME' => GetMessage('YM_TARGET_PARAMETERS'),
		'TYPE' => 'LIST',
		'VALUES' => $listProp['ALL'],
		'MULTIPLE' => 'Y',
	);
...
{
	if (!empty($arCurrentValues['PROPS_ATTRIBUTES']))
	{
		$selected = array();

		foreach ($arCurrentValues['PROPS_ATTRIBUTES'] as $code)
		{
			if (isset($arTemplateParameters['PROPS_ATTRIBUTES']['VALUES'][$code]))
			{
				$selected[$code] = $arTemplateParameters['PROPS_ATTRIBUTES']['VALUES'][$code];
			}
		}

		$arTemplateParameters['PROPS_ATTRIBUTES_SIZE'] = array(
			'PARENT' => 'DETAIL_SETTINGS',
			'NAME' => getMessage('RS_GOPRO_PROPS_ATTRIBUTES_SIZE'),
			'TYPE' => 'LIST',
	...
	$arTemplateParameters['SIZE_TABLE_USER_FIELDS'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('RS_GOPRO_SIZE_TABLE_USER_FIELDS'),
		'TYPE' => 'LIST',
		'MULTIPLE' => 'N',
		'DEFAULT' => '-',
		'ADDITIONAL_VALUES' => 'Y',
	...
	$arTemplateParameters['SIZE_TABLE_PROP'] = array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => Loc::getMessage('RS_GOPRO_SIZE_TABLE_PROP'),
		'TYPE' => 'LIST',
		'VALUES' => $listProp['E'],
		'DEFAULT' => '-',
	);
