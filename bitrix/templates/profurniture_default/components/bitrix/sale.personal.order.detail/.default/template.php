												...
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													<div class="col-md-8 col-sm-7 col-xs-10 sale-order-detail-payment-options-methods-info">
														...
														<div class="sale-order-detail-payment-options-info-order-number">
															...
															$arParams["CHECK_PAY_SYSTEM"] = array(
																17 => "NOTAX",
																18 => "TAX"
															);
															if ( !empty($arParams["CHECK_PAY_SYSTEM"]) 
																&& $arParams["CHECK_PAY_SYSTEM"][$arResult["PAY_SYSTEM_ID"]]
															) {
																?>
																<a href="/personal/order/check/?order=<?=$arResult['ID']?>&tax=<?=$arParams["CHECK_PAY_SYSTEM"][$arResult["PAY_SYSTEM_ID"]]?>" class="btn-pay-count" download=""><span>Cкачать счет</span> <i class="bill-download"></i></a>
																<?
															}
															?>
														</div>
