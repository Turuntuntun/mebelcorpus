...
?><form id="filter-sunduk" name="<?=$arResult['FILTER_NAME'].'_form'?>" action="<?=$arResult['FORM_ACTION']?>" method="get" class="smartfilter" onsubmit="return RSGoPro_FilterOnSubmitForm();"><?
	...
	?><div class="around_filtren"><?
		?><div class="filtren<?
			if($arParams['FILTER_FIXED']=='Y' && SITE_ID != 'sm'):?> filterfixed<?endif;?><?
			...
			?><div class="body"><?
				...
				foreach($arResult['ITEMS'] as $key=>$arItem) {
					...
					if(isset($arItem["PRICE"])) {
						...
						?><div class="lvl1 closed<?if($isScrolable):?> scrolable<?endif;?><?if($isSearchable):?> searcheble<?endif;?>" data-propid="<?=$arItem['ID']?>" data-propcode="<?=$arItem['CODE']?>"><?
