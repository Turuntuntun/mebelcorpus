	...
	?><div class="someform auth clearfix<?if($arResult['SECURE_AUTH']):?> secure<?endif;?>"><?
		...
		?><form name="form_auth" method="post" target="_top" action="<?=$arResult['AUTH_URL']?>"><?
			...
			?><div class="line password clearfix"><?
				...
				?><button class="btn btn-primary" type="submit" name="Login" value="<?=GetMessage('AUTH_AUTHORIZE')?>" /><?=GetMessage('AUTH_AUTHORIZE')?></button><?
			?></div><?
			...
			?><div class="line forgot clearfix"><?
				...
				?><a class="btn btn-default" href="<?=$arResult["AUTH_REGISTER_URL"]?>" rel="nofollow"><?=GetMessage('AUTH_REGISTER')?></a><?
			?></div><?
