...
<span class="c-rating js-rating" data-count="<?=$count?>" data-sum="<?=$sum?>" data-rating="<?=$rating?>" itemprop = "aggregateRating" itemscope itemtype = "http://schema.org/AggregateRating">
    <?php for ($i = 0; $i < $max; $i++): ?>
    ...
    <?php endfor; ?>
    <span class="c-rating__count" itemprop="reviewCount"><?=$count?></span>
    <meta itemprop="ratingValue" content="<?=round($sum/$count, 1)?>" />
</span>
