            ...
            ?><div class="tab-pane active" role="tabpanel" id="prop<?=$sPropCode?>"><?
                ?><div class="tab-pane-in"><?
                    ?><div class="tab-pane-in2"><?
                        ...
                        ?><div class="tab-custom-content files"><?php
                            ?><div class="row"><?
                                foreach ($arResult['PROPERTIES'][$sPropCode]['VALUE'] as $arFile) {
                                    ?><div class="col-xs-12 col-sm-6 col-md-4 col-lg-4"><?
                                        ?><a class="tab-custom-content__files__link" href="<?=$arFile['FULL_PATH']?>"><?
                                            ?><svg class="svg-icon tab-custom-content__files__svg"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-4x-file-format--<?=$arFile['TYPE']?>"></use></svg><?
                                            ?><div class="tab-custom-content__files__info"><?
                                                ?><div class="tab-custom-content__files__name"><?=$arFile['ORIGINAL_NAME']?></div><?
                                                if (isset($arFile['DESCRIPTION']))
                                                {
                                                    ?><div class="tab-custom-content__files__description"><?=$arFile['DESCRIPTION']?></div><?
                                                }
                                                ?><div class="tab-custom-content__files__size">(<?=$arFile['TYPE']?>, <?=$arFile['SIZE']?>)</div><?
                                            ?></div><?
                                        ?></a><?
                                    ?></div><?
                                }
