...
$bigdataFilter = array('ID' => $request->getPost('items'));

// $bigdataFilter['ID'] = array(21, 28, 30);

if ($_REQUEST['AJAX_CALL'] == 'Y' && $_REQUEST['ajaxpagesid'] == 'ajaxpages_bigdata' && !empty($bigdataFilter['ID'])) {
    $parameters['IS_AJAXPAGES'] = 'Y';
