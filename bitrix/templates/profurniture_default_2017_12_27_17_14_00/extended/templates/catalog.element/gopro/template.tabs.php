...
if ($arResult['TABS']['DISPLAY_PROPERTIES']) {
    ?><li role="presentation"><a href="#properties" aria-controls="home" role="tab" data-toggle="tab"><?=GetMessage('TABS_PROPERTIES')?></li></a><?
}
if ($arResult['TABS']['DELIVERY_COST']) {
    ?><li role="presentation"><a href="#deliverycost" aria-controls="home" role="tab" data-toggle="tab"><?=GetMessage('TABS_DELIVERY_COST')?></li></a><?
}
if ($arResult['TABS']['SET']) {
    ?><li role="presentation"><a href="#set" aria-controls="home" role="tab" data-toggle="tab"><?=GetMessage('TABS_SET')?></li></a><?
}
